...
오늘의 주요 한국 경제 뉴스 3개 + 세계 경제 뉴스 3개를
...
- 너무 딱딱하지 않게, 약간의 놀람/궁금함 느낌 허용

4. 뉴스 구성 (매우 중요)
- KR_1: 경제 기초 (금리 / 물가)
- KR_2: 산업 변화 (반도체 / 전기차 등)
- KR_3: 주식 직접 이슈
...
👉 전체 뉴스는 “경제 → 산업 → 주식” 흐름으로 자연스럽게 이어지게 작성

5. 퀴즈 규칙
- 각 뉴스마다 1개
- 단순 암기가 아니라 “이해 기반 문제”로 작성
- 실제 상황을 묻는 형태로 만들 것
- answerIndex는 0,1,2 골고루 분배 (랜덤 느낌)
