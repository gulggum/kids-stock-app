...
내가 준 위에 뉴스(한국 경제 뉴스 3개 + 세계 경제 뉴스 3개)를
...
- 제목은 20자 이내
- “쇼크”, “비상”, “왜 ~일까?” 같은 표현 사용
- 첫 문장은 아이가 궁금해할 질문으로 시작
- 경제 용어(금리, 물가, 환율, 반도체, AI 등)는 그대로 사용하나 괄호를 붙여 간단한 설명 작성
- 어려운 내용은 쉽게 설명
- 관련 기업 2개 포함
...
- 실제 상황을 묻는 형태로 만들 것
- answerIndex는 0,1,2 최소 2개정도만 겹치게 골고루 분배 (랜덤 느낌)
